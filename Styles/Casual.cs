...
{
    public class Casual : AbstractStyleTheme
    {
        public override XElement Normal
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='paragraph' w:default='1' w:styleId='Normal' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Normal' />  <w:qFormat />  <w:rsid w:val='00957486' /></w:style>");
            }
        }
        ...
        public override XElement NoSpacing
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='paragraph' w:styleId='NoSpacing' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='No Spacing' />  <w:uiPriority w:val='1' />  <w:qFormat />  <w:rsid w:val='00957486' />  <w:pPr>    <w:spacing w:after='0' w:line='240' w:lineRule='auto' />  </w:pPr></w:style>");
            }
        }
        ...
        public override XElement Emphasis
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:styleId='Emphasis' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Emphasis' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:uiPriority w:val='20' />  <w:qFormat />  <w:rsid w:val='00957486' />  <w:rPr>    <w:i />    <w:iCs />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement Strong
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:styleId='Strong' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Strong' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:uiPriority w:val='22' />  <w:qFormat />  <w:rsid w:val='00957486' />  <w:rPr>    <w:b />    <w:bCs />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement QuoteChar
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:customStyle='1' w:styleId='QuoteChar' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Quote Char' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:link w:val='Quote' />  <w:uiPriority w:val='29' />  <w:rsid w:val='00957486' />  <w:rPr>    <w:i />    <w:iCs />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement BookTitle
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:styleId='BookTitle' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Book Title' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:uiPriority w:val='33' />  <w:qFormat />  <w:rsid w:val='00957486' />  <w:rPr>    <w:b />    <w:bCs />    <w:smallCaps />  </w:rPr></w:style>");
            }
        }
