...
{
    public class Word2003 : AbstractStyleTheme
    {
        public override XElement Normal
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='paragraph' w:default='1' w:styleId='Normal' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Normal' />  <w:qFormat />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:sz w:val='24' />    <w:szCs w:val='24' />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement NoSpacing
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='paragraph' w:styleId='NoSpacing' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='No Spacing' />  <w:basedOn w:val='Normal' />  <w:uiPriority w:val='1' />  <w:qFormat />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:szCs w:val='32' />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement Heading6Char
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:customStyle='1' w:styleId='Heading6Char' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Heading 6 Char' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:link w:val='Heading6' />  <w:uiPriority w:val='9' />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:b />    <w:bCs />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement SubtleEmphasis
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:styleId='SubtleEmphasis' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Subtle Emphasis' />  <w:uiPriority w:val='19' />  <w:qFormat />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:i />    <w:color w:val='5A5A5A' w:themeColor='text1' w:themeTint='A5' />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement Strong
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:styleId='Strong' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Strong' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:uiPriority w:val='22' />  <w:qFormat />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:b />    <w:bCs />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement Quote
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='paragraph' w:styleId='Quote' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Quote' />  <w:basedOn w:val='Normal' />  <w:next w:val='Normal' />  <w:link w:val='QuoteChar' />  <w:uiPriority w:val='29' />  <w:qFormat />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:i />  </w:rPr></w:style>");
            }
        }
        ...
        public override XElement IntenseReference
        {
            get
            {
                return
                    XElement.Parse(
                        @"<w:style w:type='character' w:styleId='IntenseReference' xmlns:w='http://schemas.openxmlformats.org/wordprocessingml/2006/main'>  <w:name w:val='Intense Reference' />  <w:basedOn w:val='DefaultParagraphFont' />  <w:uiPriority w:val='32' />  <w:qFormat />  <w:rsid w:val='006C3494' />  <w:rPr>    <w:b />    <w:sz w:val='24' />    <w:u w:val='single' />  </w:rPr></w:style>");
            }
        }
